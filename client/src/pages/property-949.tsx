      ...
      <div className="bg-white border-b border-gray-200 px-4 sm:px-6 lg:px-8 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <h1 className="text-2xl font-bold text-gray-900">949 Kawaiahao St</h1>
          </div>
          <Dialog open={showAddRoom} onOpenChange={setShowAddRoom}>
            ...
            <DialogContent>
              ...
              <form onSubmit={handleAddSuite} className="space-y-4">
                <div>
                  <Label htmlFor="suiteNumber">Room Number</Label>
                ...
                <Button type="submit" className="w-full bg-cyan-600 hover:bg-cyan-700">Add Room</Button>
              </form>
            </DialogContent>
          </Dialog>
        </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-gray-600">View detailed pricing information and available suite rates</p>
              </div>
              <Link href="/pricing">
                <Button className="bg-cyan-600 hover:bg-cyan-700">
